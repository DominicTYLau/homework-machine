...
MOCK_RESPONSE = "1. According to Gay-Lussac's Law, the pressure of a gas increases with temperature if the volume is constant. In a hot car, the pressure inside the can increases, potentially causing it to burst."

mock = os.environ.get("MOCK_GPT", "FALSE") == "TRUE"
if mock:
    print("MOCK_GPT has been set to true. The actual API will not be queried; instead, query_gpt returns a mock response.\n")
